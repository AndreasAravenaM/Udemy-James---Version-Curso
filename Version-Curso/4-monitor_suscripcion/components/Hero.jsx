    ...
    return (
        ...
        <div className="hero-section">
            ...
            <div>
                ...
                <p className="header-text"> Gana el control
                    <br /> de tus
                    <br /> subscripciones
                ...
                <p>Mide, analiza y monitorea tus subscripciones con esta app.</p>

                <Link href="/dashboard">
                
                    <button><h5>Comienza aquí &rarr;</h5></button>
                
                </Link>

                <small>Gratis de usar. Esto sólo es un ejercicio.</small>
